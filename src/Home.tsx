	...
	return (
		<div className="Home">
			...
			<div className="plusMinusOne">
				...
				<br />
				<button className="customizeButton" onClick={setPlusStepPrompt}>Customize step</button>

			<button className="customizeButton" onClick={setMinusStepPrompt}> Customize step</button>
			<br />
			<button className="customizeButton" onClick={resetPlusStep}>Reset step</button>
			<button className="customizeButton" onClick={resetMinusStep}>Reset step</button>
				<br />
			</div>
			...
			<br />
			{/* Might still be needed, will be removed when the new  UI implementation is confrimed.
			...
			<br />
			<button className="customizeButton" style={{width:"160px"}} onClick={resetAll}>Reset everything</button>
			<br />
			<footer>
